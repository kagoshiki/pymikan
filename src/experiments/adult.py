...
MODEL = {
    ...
    "MLP-S" : lambda: MLP([104, 8, 2], hidden_activation=ACTIVATION[config["hidden_activation"]]).to(device),
    "MLP-L" : lambda: MLP([104, 104, 2], hidden_activation=ACTIVATION[config["hidden_activation"]]).to(device),
