...
config = {
    # common
    "model": "SharedMIKAN_NodeWiseEmbedding",
    "batch_size": 64,
    "widths": [784, 64, 10],
    "optimizer": "AdamW",
    "learning_rate": 0.005,
    ...
    "num_epoch_update_only_embedding": 20,
